...
namespace GAS
{
    ...
    public class GameplayEffect
    {
        ...
        [SerializeField]
        private List<AttributeModifierDefinition> modifierDefinitions = new();

        public IReadOnlyList<AttributeModifierDefinition> ModifierDefinitions =>
            modifierDefinitions;

        public bool HasModifiers =>
            modifierDefinitions.Count > 0 ||
        ...
        /// <summary>
        /// Creates a legacy runtime copy of this gameplay effect.
        /// </summary>
        [EasyButtons.Button]
        public GameplayEffect Instantiate()
        {
            ...
            {
                geCopy.gameplayEffectTags.FillTags(
                    geCopy);

                geCopy.gameplayEffectTags.ClearStrings();
            }
