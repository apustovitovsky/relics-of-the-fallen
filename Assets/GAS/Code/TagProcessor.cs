...
namespace GAS
{
    ...
    public static class TagProcessor
    {
        ...
        public static void UpdateTags(
            ...
            ref List<GameplayTag> currentTags,
            List<GameplayEffect> appliedGameplayEffects,
            List<GameplayAbility> gameplayAbilities,
            Action<List<GameplayTag>, AbilitySystemComponent, AbilitySystemComponent, string> OnTagsChanged,
            string activationGUID)
        {
                     ...
                     in appliedGameplayEffects)
            {
                ...
                foreach (GameplayTag grantedTag
                         in appliedEffect
                             .gameplayEffectTags
                             .GrantedTags)
                {
